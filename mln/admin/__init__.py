...
from ..models.static import Answer, ArcadePrize, BlueprintInfo, BlueprintRequirement, ItemInfo, ItemType, MessageBody, MessageTemplate, MessageTemplateAttachment, ModuleEditorType, ModuleExecutionCost, ModuleInfo, ModuleSetupCost, ModuleYieldInfo, NetworkerFriendTrigger, NetworkerReplyTrigger, StartingStack, Question
...
reply_trigger_admin.list_display_links = "body",
reply_trigger_admin.search_fields = "networker", "body__subject", "body__text", "trigger", "source", "notes"
