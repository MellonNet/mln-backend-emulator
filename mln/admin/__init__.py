...
trigger_admin.list_display = "sender", "response", "message_body", "message_attachment", "trigger"
trigger_admin.list_display_links = "response",
trigger_admin.search_fields = "sender", "response__subject", "response__text", "trigger", "source", "notes"
