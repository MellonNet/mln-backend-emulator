...
from mln.models.static import ModuleEditorType
...
class Migration(migrations.Migration):
	...
	operations = [
		migrations.AddField(
			...
			name='editor_type',
			field=mln.models.static.EnumField(mln.models.static.ModuleEditorType, default=ModuleEditorType.GENERIC, null=True, blank=True),
