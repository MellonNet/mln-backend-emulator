...
class FriendSendInvitation(TestCase, metaclass=req_resp):
	SETUP = two_users,
	DIR = "friend"
	VOID_TESTS = "friend_send_invitation",

class FriendProcessInvitation(TestCase, metaclass=req_resp):
	SETUP = pending_friends_other_way,
	DIR = "friend"
	VOID_TESTS = "friend_process_invitation",

class Friend(TestCase, metaclass=req_resp):
	SETUP = friends,
	DIR = "friend"
	VOID_TESTS = "friend_remove_member", "friend_process_blocking_block"

class FriendProcessBlockingUnblock(TestCase, metaclass=req_resp):
